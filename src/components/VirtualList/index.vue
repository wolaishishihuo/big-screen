  ...
  <div class="fs-estimated-virtuallist-container">
    ...
    >
      <div ref="listRef" class="fs-estimated-virtuallist-list" :style="scrollStyle">
        <div v-for="i in renderList" ref="itemRef" :key="i.project_id" class="fs-estimated-virtuallist-list-item">
          <slot name="item" :item="i" />
        </div>
      </div>

      <div class="fs-estimated-virtuallist-list" :style="scrollStyle">
        <div v-for="i in virList" :key="i.project_id" class="fs-estimated-virtuallist-list-item">
          <slot name="item" :item="i" />
        </div>
      </div>
    </div>
...
import type { VirtualStateType } from './type';
...
// raf节流
function rafThrottle(fn: (...args: any[]) => void) {
  let lock = false;
